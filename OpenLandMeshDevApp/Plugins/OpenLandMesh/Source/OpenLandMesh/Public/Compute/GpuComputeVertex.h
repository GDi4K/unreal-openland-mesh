...
class OPENLANDMESH_API FGpuComputeVertex
{
	...
	static void ApplyParameterValues(UMaterialInstanceDynamic* Material, TArray<FComputeMaterialParameter> MaterialParameters);
...
public:
	...
	void Compute(UObject* WorldContext, TArray<FGpuComputeVertexOutput>& ModifiedData, FComputeMaterial ComputeMaterial);
};
